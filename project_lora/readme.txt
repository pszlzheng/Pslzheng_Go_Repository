...
注意事项:
	...
	4,字库更新,需自备SD卡一个,并拷贝光盘:6，SD卡根目录文件 对应使用板子下的，里面的所有内容到SD卡根目录,然后将           SD卡插到开发板.
	5,如果触摸屏不准，请按住KEY0不放，然后按复位，松开复位，进入触摸屏校准。此时松开KEY0，执行校准，即可对屏幕          进行校准。
